...
module.exports = (robot) ->
  robot.hear /(?:what's|what’s|what is) (?:\bthe menu\b|\bfor lunch\b)( in R2)? *(?:for|on)? *(tomorrow|Monday|Tuesday|Wednesday|Thursday|Friday)?/i, (res) ->
    restaurant = 'r1'
    if res.match[1]
      restaurant = 'r2'
  ...
  robot.hear /(?:what's|what’s|what is) the (\w+|rabbit food) (?:\bmenu\b|\blunch\b|\boption\b|\bchoice\b|\bdish\b)? (in R2)? *(?:for|on)? *(tomorrow|Monday|Tuesday|Wednesday|Thursday|Friday)?/i, (res) ->
